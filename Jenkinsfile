pipeline {
  ...
  parameters {
    string(name: 'NEW_VERSION',    defaultValue: '6.3.0',     description: 'Target CN/K8s bundle to install')
    ...
    choice(name: 'BUILD_TRANSFER_MODE', choices: 'scp\nrsync', description: 'Used only when FETCH_BUILD=true')
